...
const displayCategory=(categories)=>{
    ...
    categories.forEach(category => {
        ...
        categoryBox.innerHTML=`
                 <li id=${category.id} class=" border-b-2 border-transparent hover:border-b-2  hover:border-b-red-500 cursor-pointer">${category.title}</li>
                 `
...
const showLoading=()=>{
    newsContainer.innerHTML=`
      <div class="max-w-7xl mx-auto col-span-full">
